# Task: Migrate Consumer Service from RabbitMQ to Azure Service Bus

## Task Overview

Migrate the consumer service (demo) from RabbitMQ to Azure Service Bus while maintaining the WebSocket broadcast functionality for real-time browser notifications. The consumer will receive messages from an Azure Service Bus queue and broadcast them to connected WebSocket clients.
