...
3. **Generate tasks**: Generate task details md for each task in the plan
    ...
    2) Find the right skill md files described in `.appmod-kit/skills/skill-index.json` created by script `.appmod-kit/scripts/powershell/create-plan.ps1 -Json`, to pickup the right skill, you need to think about below rules to pickup the right skills, **DO NOT** read the skill files in the plan phase:
       - Source resource
